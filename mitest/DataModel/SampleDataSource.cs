...
namespace SearchCharms.Data
{
    ...
    public abstract class SampleDataCommon : SearchCharms.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-1",
                    ...
                    "Russian Red está de vuelta con “Agent Cooper”, un disco guitarrero grabado en Los Ángeles y con vocación internacional. Por Wilma Lorenzo.",
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-2",
                    ...
                    "Jose Domingo se mueve por el Mediterráneo y su música se impregna de los diferentes sonidos que baña. En su nuevo disco, “Almería”, el tercero, su rock se muestra absolutamente personal. Por Chema Domínguez.",
                    "Assets/DarkGray.png",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT,
                    group1));
            group1.Items.Add(new SampleDataItem("Group-1-Item-3",
                    "Albert Pla: Dispuesto a manifestarse",
                    "Esta entrevista tuvo lugar a mediados de enero, poco antes de que Albert Pla fuera ingresadopor una dolencia cardíaca, lo que le obligó a suspender la gira prevista. Días después, restablecido, respondió a algunas cuestiones por mail. Por Chema Domínguez.",
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-4",
                    ...
                    "Ricardo Vicente (Tachenko, La Costa Brava, Francisco Nixon) debuta en solitario con “¿Qué haces tan lejos de casa?”, una novela acompañada de canciones escritas expresamente para ella. Por Wilma Lorenzo.",
                    "Assets/DarkGray.png",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT,
                    group1));
            ...
            group2.Items.Add(new SampleDataItem("Group-2-Item-1",
                    "Los tres primeros discos de Led Zeppelin serán reeditados este año",
                    "Jimmy Page sigue dando con cuentagotas la información sobre la reedición de la discografía de Led Zeppelin.",
                    "Assets/DarkGray.png",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT,
                    group2));
            group2.Items.Add(new SampleDataItem("Group-2-Item-2",
                    "La discografía de Led Zeppelin ya está en Spotify",
                    "Desde hoy, 11 de diciembre, la discografía de Led Zeppelin está Spotify, como la propia banda ha anunciado desde Twitter",
                    "Assets/MediumGray.png",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT,
                    group2));
            ...
            group3.Items.Add(new SampleDataItem("Group-3-Item-1",
                    "Descubiertas unas grabaciones de Led Zeppelin en las que canta John Paul Jones",
                    "Robert Plant ha descubierto unas grabaciones inéditas de Led Zeppelin en las que en algunas canciones no canta él, sino el bajista John Paul Jones. ",
                    "Assets/MediumGray.png",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT,
                    group3));
